<x-tenant-theme::pages.layout>
    <section class="mb-6">
        <x-tenant-theme::breadcrumb :links="[['url' => null, 'title' => 'الأسئلة المتكررة']]" />
        {{-- <x-tenant-theme::page-title title="الأسئلة المتكررة" desc="إجابات سريعة لأكثر الأسئلة شيوعا حول الخدمات، المواعيد، والتسعير." /> --}}
    </section>
