...
<div class="p-1 md:p-px bg-{{ theme_option('bgColor', 'stone-200') }} min-h-screen X[background-image:linear-gradient(rgba(255,255,255,0.2)_2px,transparent_2px),linear-gradient(90deg,rgba(255,255,255,0.3)_2px,transparent_2px)] [background-size:40px_40px]">
