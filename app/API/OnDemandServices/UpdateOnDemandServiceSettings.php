...
/**
 * Saves on-demand services section customize settings.
 */
class UpdateOnDemandServiceSettings
{
    use AsAction;
    ...
    public function handle(Tenant $tenant, array $data): array
    {
        ...
        Setting::saveForSlug(Setting::ON_DEMAND_SERVICE_SETTINGS_SLUG, [
            'section_title' => $data['section_title'],
            'section_description' => $data['section_description'],
        ]);

        return GetOnDemandServiceSettings::make()->handle($tenant);
    }
