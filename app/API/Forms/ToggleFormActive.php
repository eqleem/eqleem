...
/**
 * Toggles active state for a form.
 */
class ToggleFormActive
{
    use AsAction;
    ...
    public function jsonResponse(Content $content): FormListResource
    {
        return (new FormListResource($content))
            ->additional([
                'message' => $content->active ? 'تم تفعيل النموذج.' : 'تم تعطيل النموذج.',
            ]);
    }
}
