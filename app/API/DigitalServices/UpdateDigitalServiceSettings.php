...
/**
 * Saves store section customize settings.
 */
class UpdateDigitalServiceSettings
{
    use AsAction;
    ...
    public function handle(Tenant $tenant, array $data): array
    {
        ...
        Setting::saveForSlug(Setting::DIGITAL_SERVICE_SETTINGS_SLUG, [
            'section_title' => $data['section_title'],
            'section_description' => $data['section_description'],
        ]);

        return GetDigitalServiceSettings::make()->handle($tenant);
    }
