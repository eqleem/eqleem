...
/**
 * Lean payload for the dashboard digital products table.
 *
 * @mixin Content
 */
class DigitalProductListResource extends JsonResource
{
    /**
    ...
    {
        $first = $content->getFirstMedia('digital-product-media');
