...
/**
 * Lean payload for the dashboard digital services table.
 *
 * @mixin Content
 */
class DigitalServiceListResource extends JsonResource
{
    /**
    ...
    {
        $first = $content->getFirstMedia('digital-service-media');
