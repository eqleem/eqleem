<div class="relative col-span-1 flex rounded-xl shadow-sm group">
    <a href="{{ route('admin.page.home') }}" wire:navigate.hover
        ...
        <img class="h-10" src="{{ asset('assets/icons/business/009-web browser.svg') }}" alt="">
    </a>

    <div class="flex flex-1 items-center justify-between truncate rounded-e-xl border-stone-200 bg-white">
        <a href="{{ route('admin.page.home') }}" wire:navigate.hover class="flex-1 truncate px-3 py-3 text-sm">
...
new class extends \Livewire\Component {
    ...
    function mount()
    {
        [$this->value, $this->growth] = Value::make(RequestAnalytics::class)
