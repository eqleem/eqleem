<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: تصميم جرافيك" />
    ...
    @if ($categoryId)
        <ui:input
            ...
            label="نص الرابط"
            dir="ltr"
            placeholder="مثال: graphic-design"
            info="يُستخدم في فلترة الخدمات الرقمية عبر الرابط."
        />
    @endif
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('digital_service_category')->find($this->categoryId);
        ...
        foreach (Taxonomy::flatTree('digital_service_category') as $item) {
    ...
    public function submit(): void
    {
        ...
        if ($this->categoryId) {
            ...
            $modal = 'edit-digital-service-category';
        } else {
            ...
            $modal = 'add-digital-service-category';
        }

        $this->dispatch('updateDigitalServiceCategoryList');
