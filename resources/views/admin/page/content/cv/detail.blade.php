    ...
    <ui:mainbox :title="$item['title']" :subtitle="$contentType['name']">
        ...
        <div class="px-4 lg:px-8 space-y-4">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                تفاصيل قسم السيرة الذاتية — سيتم استبدال هذه البيانات لاحقاً من قاعدة البيانات.
            </p>
        </div>
    </ui:mainbox>
</div>
...
new class extends \Livewire\Component
{
    ...
    {
        return collect([
            ['id' => 1, 'title' => 'الملف الشخصي', 'subtitle' => 'مكتمل'],
            ['id' => 2, 'title' => 'الخبرات العملية', 'subtitle' => '٤ خبرات'],
            ['id' => 3, 'title' => 'المهارات والشهادات', 'subtitle' => '٨ مهارات'],
        ])->firstWhere('id', (int) $this->itemId) ?? [
            'id' => (int) $this->itemId,
            'title' => 'قسم #'.$this->itemId,
            'subtitle' => '—',
        ];
    }
