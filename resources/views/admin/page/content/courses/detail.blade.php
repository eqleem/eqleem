    ...
    <ui:mainbox :title="$item['title']" :subtitle="$contentType['name']">
        ...
        <div class="px-4 lg:px-8 space-y-4">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                تفاصيل الدورة التدريبية — سيتم استبدال هذه البيانات لاحقاً من قاعدة البيانات.
            </p>
        </div>
    </ui:mainbox>
</div>
...
new class extends \Livewire\Component
{
    ...
    {
        return collect([
            ['id' => 1, 'title' => 'دورة تصميم الواجهات', 'subtitle' => '١٢ درس — منشورة'],
            ['id' => 2, 'title' => 'دورة التسويق الرقمي', 'subtitle' => '٨ دروس — منشورة'],
            ['id' => 3, 'title' => 'دورة البرمجة للمبتدئين', 'subtitle' => '١٥ درس — مسودة'],
        ])->firstWhere('id', (int) $this->itemId) ?? [
            'id' => (int) $this->itemId,
            'title' => 'دورة #'.$this->itemId,
            'subtitle' => '—',
        ];
    }
