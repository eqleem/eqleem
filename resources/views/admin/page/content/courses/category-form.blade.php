<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: تطوير الذات" />
    ...
    @if ($categoryId)
        <ui:input
            ...
            label="نص الرابط"
            dir="ltr"
            placeholder="مثال: self-development"
            info="يُستخدم في فلترة الدورات عبر الرابط."
        />
    @endif
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('course_category')->find($this->categoryId);
        ...
        foreach (Taxonomy::flatTree('course_category') as $item) {
    ...
    public function submit(): void
    {
        ...
        if ($this->categoryId) {
            ...
            $modal = 'add-course-category';
        }

        $this->dispatch('updateCourseCategoryList');
