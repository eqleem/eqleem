    ...
    <ui:mainbox :title="$item['title']" :subtitle="$contentType['name']">
        ...
        <div class="px-4 lg:px-8 space-y-4">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                تفاصيل الصفحة — سيتم استبدال هذه البيانات لاحقاً من قاعدة البيانات.
            </p>
        </div>
    </ui:mainbox>
</div>
...
new class extends \Livewire\Component
{
    ...
    {
        return collect([
            ['id' => 1, 'title' => 'صفحة من نحن', 'subtitle' => 'منشورة'],
            ['id' => 2, 'title' => 'صفحة تواصل معنا', 'subtitle' => 'منشورة'],
            ['id' => 3, 'title' => 'صفحة الأسئلة الشائعة', 'subtitle' => 'مسودة'],
        ])->firstWhere('id', (int) $this->itemId) ?? [
            'id' => (int) $this->itemId,
            'title' => 'صفحة #'.$this->itemId,
            'subtitle' => '—',
        ];
    }
