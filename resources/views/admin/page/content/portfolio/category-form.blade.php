<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: تصميم داخلي" />
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('portfolio_category')->find($this->categoryId);
    ...
    public function submit(): void
    {
        ...
        if ($this->categoryId) {
            ...
            $modal = 'add-portfolio-category';
        }

        $this->dispatch('updatePortfolioCategoryList');
