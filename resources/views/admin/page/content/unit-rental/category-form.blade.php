<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: غرف فندقية" />
    ...
    @if ($categoryId)
        <ui:input
            ...
            label="نص الرابط"
            dir="ltr"
            placeholder="مثال: hotel-rooms"
            info="يُستخدم في فلترة الوحدات عبر الرابط."
        />
    @endif
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('unit_category')->find($this->categoryId);
        ...
        foreach (Taxonomy::flatTree('unit_category') as $item) {
    ...
    public function submit(): void
    {
        ...
        if ($this->categoryId) {
            ...
            $modal = 'add-unit-category';
        }

        $this->dispatch('updateUnitCategoryList');
