<div class="divide-y divide-gray-200 divide-dotted">
    <div class="px-4 py-4 border-b border-stone-100">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h3 class="text-base font-semibold text-gray-800">مخزون الوحدات</h3>
            ...
            <ui:button wire:click="openAddModal" label="أضف وحدة" icon="square-rounded-plus" />
        </div>
    </div>
    ...
    <div class="bg-gray-100 p-3 flex items-center gap-x-4 w-full">
        ...
        <ui:modal :title="$editingCalendarId ? 'تعديل وحدة المخزون' : 'إضافة وحدة للمخزون'" size="3xl" name="unit-rental-calendar-form">
            <livewire:admin::page.content.unit-rental.calendar-form
                :calendar-id="$editingCalendarId"
                :key="'unit-rental-calendar-form-'.($editingCalendarId ?? 'new')"
            />
        </ui:modal>
    </div>
    ...
    <div class="relative overflow-x-auto">
        @if ($calendars->isEmpty())
            <ui:empty subtitle="سيتم عرض مخزون الوحدات هنا بعد إضافته.">
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach ($calendars as $calendar)
                        <tr wire:key="unit-rental-calendar-{{ $calendar->id }}" class="hover:bg-gray-50">
                            <td class="px-6 py-4">
...
<button type="button"
                                            ...
                                            <button type="button"
                                                ...
                                                wire:confirm="هل أنت متأكد من حذف هذه الوحدة من المخزون؟"
                                                @click="dropdownMenu = false"
...
new class extends \Livewire\Component
{
    ...
    #[On('updateUnitRentalCalendarList')]
    ...
    {
        $this->editingCalendarId = null;
        $this->dispatch('openmodal', modal: 'unit-rental-calendar-form');
    }
