    ...
    <ui:mainbox :title="$item['title']" :subtitle="$contentType['name']">
        ...
        <div class="px-4 lg:px-8 space-y-4">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                تفاصيل الطبق — سيتم استبدال هذه البيانات لاحقاً من قاعدة البيانات.
            </p>
        </div>
    </ui:mainbox>
</div>
...
new class extends \Livewire\Component
{
    ...
    {
        return collect([
            ['id' => 1, 'title' => 'طبق تجريبي ١', 'subtitle' => 'مقبلات'],
            ['id' => 2, 'title' => 'طبق تجريبي ٢', 'subtitle' => 'أطباق رئيسية'],
        ])->firstWhere('id', (int) $this->itemId) ?? [
            'id' => (int) $this->itemId,
            'title' => 'طبق #'.$this->itemId,
            'subtitle' => '—',
        ];
    }
