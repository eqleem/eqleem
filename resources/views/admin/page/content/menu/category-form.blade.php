<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: مقبلات" />
    ...
    @if ($categoryId)
        <ui:input
            ...
            label="نص الرابط"
            dir="ltr"
            placeholder="مثال: appetizers"
            info="يُستخدم في فلترة الأطباق عبر الرابط."
        />
    @endif
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('menu_category')->find($this->categoryId);
        ...
        foreach (Taxonomy::flatTree('menu_category') as $item) {
    ...
    public function submit(): void
    {
        ...
        if ($this->categoryId) {
            ...
            $modal = 'add-menu-category';
        }

        $this->dispatch('updateMenuCategoryList');
