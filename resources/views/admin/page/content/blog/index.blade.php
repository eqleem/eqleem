    ...
    <ui:mainbox :title="$contentType['name']" :subtitle="$contentType['description']">
        ...
        >
            <x-slot name="nav" class="border-b border-stone-200 px-px">
                ...
                <ui:tab.nav name="customize" label="تخصيص المدونة" icon="settings" activeClass="border-b-2 !border-primary-500 text-stone-900" />
            </x-slot>
            ...
            <x-slot name="content">
                ...
                <ui:tab.content name="customize" class="!p-4">
                    <livewire:admin::page.content.blog.customize lazy />
                </ui:tab.content>
            </x-slot>
        </ui:tab.group>
    </ui:mainbox>
