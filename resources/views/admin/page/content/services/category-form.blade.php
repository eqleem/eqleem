<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: استشارات" />
    ...
    @if ($categoryId)
        <ui:input
            ...
            label="نص الرابط"
            dir="ltr"
            placeholder="مثال: consulting"
            info="يُستخدم في فلترة الخدمات عبر الرابط."
        />
    @endif
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('service_category')->find($this->categoryId);
        ...
        foreach (Taxonomy::flatTree('service_category') as $item) {
    ...
    public function submit(): void
    {
        ...
        $this->dispatch('updateServiceCategoryList');
