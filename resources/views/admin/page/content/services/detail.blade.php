    ...
    <ui:mainbox :title="$item['title']" :subtitle="$contentType['name']">
        ...
        <div class="px-4 lg:px-8 space-y-4">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                تفاصيل الخدمة — سيتم استبدال هذه البيانات لاحقاً من قاعدة البيانات.
            </p>
        </div>
    </ui:mainbox>
</div>
...
new class extends \Livewire\Component
{
    ...
    {
        return collect([
            ['id' => 1, 'title' => 'خدمة تجريبية ١', 'subtitle' => 'استشارات'],
            ['id' => 2, 'title' => 'خدمة تجريبية ٢', 'subtitle' => 'صيانة'],
        ])->firstWhere('id', (int) $this->itemId) ?? [
            'id' => (int) $this->itemId,
            'title' => 'خدمة #'.$this->itemId,
            'subtitle' => '—',
        ];
    }
