<ui:form wire:submit="submit">
    <ui:input name="name" label="اسم التصنيف" placeholder="مثال: قوالب رقمية" />
    ...
    @if ($categoryId)
        <ui:input
            ...
            label="نص الرابط"
            dir="ltr"
            placeholder="مثال: digital-templates"
            info="يُستخدم في فلترة المنتجات الرقمية عبر الرابط."
        />
    @endif
...
new class extends \Livewire\Component
{
    ...
    public function parentOptions(): array
    {
        ...
        if ($this->categoryId) {
            $category = Taxonomy::query()->type('digital_store_category')->find($this->categoryId);
        ...
        foreach (Taxonomy::flatTree('digital_store_category') as $item) {
    ...
    public function submit(): void
    {
        ...
        if ($this->categoryId) {
            ...
            $modal = 'edit-digital-product-category';
        } else {
            ...
            $modal = 'add-digital-product-category';
        }

        $this->dispatch('updateDigitalProductCategoryList');
