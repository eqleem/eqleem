    ...
    <ui:mainbox :title="$item['title']" :subtitle="$contentType['name']">
        ...
        <div class="px-4 lg:px-8 space-y-4">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                تفاصيل المنتج الرقمي — سيتم استبدال هذه البيانات لاحقاً من قاعدة البيانات.
            </p>
        </div>
    </ui:mainbox>
</div>
...
new class extends \Livewire\Component
{
    ...
    {
        return collect([
            ['id' => 1, 'title' => 'قالب تصميم جاهز', 'subtitle' => 'ملف ZIP — ٤٩ ر.س'],
            ['id' => 2, 'title' => 'حزمة أيقونات', 'subtitle' => 'ملف SVG — ٢٩ ر.س'],
            ['id' => 3, 'title' => 'دليل إلكتروني', 'subtitle' => 'PDF — ١٩ ر.س'],
        ])->firstWhere('id', (int) $this->itemId) ?? [
            'id' => (int) $this->itemId,
            'title' => 'منتج رقمي #'.$this->itemId,
            'subtitle' => '—',
        ];
    }
