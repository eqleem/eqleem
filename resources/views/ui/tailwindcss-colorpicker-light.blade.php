...
<div class="bg-gray-100/75 p-1 rounded-lg">
         ...
         setIconWhite()" :id="$id('{{ $name }}')">
            ...
            17h.01" />
                    ...
                    <div x-show="isOpen" @click.away="isOpen = false"
                        ...
                        class="border border-gray-300 ltr:origin-top-left absolute ltr:left-0 rtl:right-0 top-full mt-2 rounded-md shadow-lg z-10">
