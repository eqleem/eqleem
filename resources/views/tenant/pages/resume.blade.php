<x-tenant::pages.layout width="max-w-5xl">
    <x-tenant::breadcrumb :links="[['url' => null, 'title' => 'السيرة الذاتية']]" />
    {{-- <x-tenant::page-title title="السيرة الذاتية" desc="يمكنك تحميل السيرة الذاتية والتواصل معي مباشرة." /> --}}
