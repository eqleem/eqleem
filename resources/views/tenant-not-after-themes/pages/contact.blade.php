<x-tenant::pages.layout>
    <section class="mb-6">
        <x-tenant::breadcrumb :links="[['url' => null, 'title' => 'اتصل بنا']]" />
        <x-tenant::page-title title="اتصل بنا" desc="تواصل معنا مباشرة عبر النموذج، الجوال، البريد الإلكتروني، أو الواتساب." />
    </section>
