...
class Paragraph {
    ...
    onPaste(event) {
        const data = {
            ...
            alignment:
                this.config.defaultAlignment || Paragraph.DEFAULT_ALIGNMENT,
        };
    ...
    static get toolbox() {
        return {
            icon: '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M2.67 7.17V5.35c0-1.15.93-2.07 2.07-2.07h14.52c1.15 0 2.07.93 2.07 2.07v1.82M12 20.72V4.11M8.06 20.72h7.88" stroke="#FF8A65" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
            title: "Text",
        };
    }
}
