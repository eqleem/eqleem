...
class Header {
    ...
    get data() {
        ...
        this._data.alignment =
            this._data.alignment ||
            this._settings.defaultAlignment ||
            Header.DEFAULT_ALIGNMENT;
    ...
    getTag() {
        ...
        tag.classList.add(
            this._CSS.wrapper,
            this._CSS.alignment[this._data.alignment]
        );
    ...
    onPaste(event) {
        ...
        this.data = {
            ...
            alignment: this._settings.defaultAlignment,
            // this._settings.defaultAlignment || Header.DEFAULT_ALIGNMENT,
        };
    }
    ...
    static get DEFAULT_ALIGNMENT() {
        return Header.ALIGNMENTS.right;
    }
