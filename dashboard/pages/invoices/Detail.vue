                ...
                <Section title="تفاصيل الفاتورة" icon="invoice">
                    <div class="p-5">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-2">
                            ...
                            <div><dt class="mb-1 text-xs text-gray-400">الحالة</dt><dd><Badge :color="invoice.status_color">{{ invoice.status_label }}</Badge></dd></div>
                            <div><dt class="mb-1 text-xs text-gray-400">النوع</dt><dd class="text-sm text-gray-800">{{ invoice.type_label }}</dd></div>
