...
<template>
    <div class="divide-y divide-dotted divide-stone-200">
        <div class="flex w-full items-center gap-x-7 bg-stone-100 p-3">
            <div class="flex-grow">
        ...
        <div class="relative p-1">
            ...
            >
                ...
                <small class="text-stone-500">ستظهر فواتير هذا العميل هنا بعد تسجيل أي دفعة أو إصدار فاتورة لطلباته.</small>
            </div>
                        ...
                        <RouterLink :to="`/invoices/${item.uuid}`" class="block">
                            ...
                            <div class="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-stone-500">
                                <span
                                    ...
                                    class="inline-flex items-center gap-x-1 rounded-md bg-stone-100 p-1 px-2 text-xs"
