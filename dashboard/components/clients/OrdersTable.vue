...
onMounted(() => {
    ...
    if (clientUuid.value && (orders.value.clientUuid !== clientUuid.value || !orders.value.loaded)) {
    ...
    <div class="divide-y divide-dotted divide-gray-200">
        ...
        <div class="relative p-1">
            ...
            >
                ...
                <small class="text-gray-500">سيتم عرض طلبات هذا العميل هنا بعد إنشائها.</small>
            </div>
            ...
            <div v-else-if="items.length > 0">
                ...
                >
                    <div class="min-w-0 flex-1 py-3">
                        <RouterLink :to="`/orders/${item.uuid}`" class="block">
                            <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
                                <h2 class="text-lg font-semibold text-gray-700">#{{ item.number }}</h2>
                    ...
                    <div class="hidden shrink-0 items-center gap-x-6 text-sm text-gray-600 sm:flex">
                        <div class="text-end">
                            <div class="font-bold text-gray-800"><Money :formatted="item.grand_total_formatted" /></div>
                            <div class="mt-0.5 text-xs text-gray-400">{{ item.items_count }} منتج</div>
                        </div>
