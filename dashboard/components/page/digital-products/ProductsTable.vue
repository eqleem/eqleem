    ...
    <div class="divide-y divide-dotted divide-gray-200">
        ...
        <div class="relative p-1">
            ...
            <div v-else-if="store.isEmpty" class="flex flex-col items-center justify-center gap-2 p-10 text-center">
                ...
                <p class="text-gray-700">لا توجد منتجات رقمية.</p>
                <small class="text-gray-500">سيتم عرض المنتجات الرقمية هنا بعد إضافتها.</small>
            </div>
                        ...
                        <RouterLink :to="`/manage/digital-products/detail/${item.uuid}`" class="flex items-center gap-x-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1 flex items-center gap-x-2">
                                    ...
                                    <span v-if="item.downloads_count > 0" class="text-xs text-gray-500">
