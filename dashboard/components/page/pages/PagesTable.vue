    ...
    <div class="divide-y divide-dotted divide-gray-200">
        ...
        <div class="relative p-1">
            ...
            <div v-else-if="store.isEmpty" class="flex flex-col items-center justify-center gap-2 p-10 text-center">
                ...
                <p class="text-gray-700">لا توجد صفحات.</p>
                <small class="text-gray-500">سيتم عرض الصفحات هنا بعد إضافتها.</small>
            </div>
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1 flex items-center gap-x-2">
                                    ...
                                    <p class="mt-1 flex items-center gap-1 text-xs text-gray-500">
                                        <span class="inline-flex items-center gap-x-1 rounded-md bg-gray-100 p-1 px-2 text-xs">
                                            {{ item.status_label }}
                                        </span>
                                        <span
                                        ...
                                        <span v-if="item.published_at_label" class="inline-block" dir="ltr">
