        ...
        >
            ...
            >
                <div class="mb-2 flex items-center justify-between px-1">
                    ...
                    <button
                        type="button"
                        class="rounded-lg p-1.5 text-gray-500 transition hover:bg-white/70 hover:text-gray-800"
                ...
                <div>
                    <p class="mt-3 px-3 py-1 text-xs text-gray-400">المحتوى</p>
                    <div class="mx-1 mb-2 border-t border-dotted border-gray-300"></div>
                </div>
