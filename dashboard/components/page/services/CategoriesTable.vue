...
function openEdit(categoryId) {
    ...
    openModal('edit-service-category');
}
...
<template>
    <div class="divide-y divide-dotted divide-stone-200">
        <div class="flex w-full items-center gap-x-4 bg-white p-3">
            ...
            >
                <CategoryForm
                    ...
                    modal-name="add-service-category"
                />
            </Modal>
        </div>
        ...
        <Modal title="تعديل التصنيف" size="lg" name="edit-service-category">
            <CategoryForm
                v-if="editingCategoryId"
                :key="`edit-${editingCategoryId}`"
                :category-id="editingCategoryId"
                modal-name="edit-service-category"
            />
        </Modal>
    </div>
</template>
