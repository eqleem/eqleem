        ...
        <div class="p-1">
            ...
            >
                <div class="flex min-w-0 items-center gap-3">
                    <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gray-100 text-gray-400">
                    ...
                    <div class="min-w-0">
                        <p class="truncate font-medium text-gray-800">{{ category.name }}</p>
                        <span class="text-xs text-gray-400">{{ category.count }} عنصر</span>
                    </div>
                </div>
