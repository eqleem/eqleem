...
const subTabs = [
    { key: 'courses', label: 'الدورات', to: '/manage/courses' },
    { key: 'categories', label: 'التصنيفات', to: '/manage/courses/categories' },
    { key: 'customize', label: 'تخصيص القسم', to: '/manage/courses/settings' },
];
</script>
