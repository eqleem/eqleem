...
<template>
    <div class="divide-y divide-dotted divide-gray-200">
        <div class="flex w-full items-center gap-x-4 bg-white p-3">
            ...
            <Button label="دورة جديدة" @click="openModal('add-course')">
                <template #icon>
            ...
            <Modal title="إضافة دورة تدريبية جديد" size="2xl" name="add-course">
                <AddCourse />
            </Modal>
        </div>
        ...
        <div class="relative p-1">
            ...
            <div v-else-if="store.isEmpty" class="flex flex-col items-center justify-center gap-2 p-10 text-center">
                ...
                <p class="text-gray-700">لا توجد دورات تدريبية.</p>
                <small class="text-gray-500">سيتم عرض الدورات التدريبية هنا بعد إضافتها.</small>
            </div>
            ...
            <div v-else>
                ...
                >
                    ...
                    <div class="w-full py-3">
                        <RouterLink :to="`/manage/courses/detail/${item.uuid}`" class="flex items-center gap-x-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1 flex items-center gap-x-2">
                                    ...
                                    <span v-if="item.level_label" class="text-xs text-gray-500">{{ item.level_label }}</span>
                                    <span v-if="item.hours_label" class="text-xs text-gray-500">{{ item.hours_label }} ساعة</span>
                    ...
                    <div class="pe-6">
                        <Dropdown width="w-36">
                            ...
                            <RouterLink
                                :to="`/manage/courses/detail/${item.uuid}`"
