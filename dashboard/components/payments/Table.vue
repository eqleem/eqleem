                ...
                >
                    <div class="min-w-0 flex-1 space-y-2 py-3">
                        ...
                        <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
                            ...
                            ></div>
                            <div class="h-5 w-16 rounded-md bg-gray-100"></div>
                            <div class="h-3 w-24 rounded-md bg-gray-100"></div>
                        </div>
                    </div>
                    ...
                    <div class="min-w-0 flex-1 py-3">
                        <RouterLink :to="`/payments/${item.uuid}`" class="block">
                            ...
                            <div class="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-gray-500">
                                ...
                                <span v-if="item.gateway_label" class="inline-flex items-center gap-x-1 rounded-md bg-gray-100 p-1 px-2 text-xs">{{ item.gateway_label }}</span>
